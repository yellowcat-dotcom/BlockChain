...
public class Blockchain {
    ...
    // Метод для получения текущей сложности майнинга
    public int getDifficulty() {
        return difficulty;
    }

    // Метод для получения последнего блока в блокчейне
    public Block latestBlock() {
        return blocks.get(blocks.size() - 1);
    }

    // Метод для создания нового блока с указанными данными
    ...
    // Метод для проверки валидности первого блока (генезис-блока)
    ...
    // Метод для проверки валидности нового блока относительно предыдущего блока
    ...
    // Метод для проверки валидности всего блокчейна
